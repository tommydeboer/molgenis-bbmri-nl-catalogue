...
public class PromiseMaterialTypeMetadata extends SystemEntityType
{
	...
	public static final String PROMISE_TYPE = "promiseMaterialType";
	...
	protected void init()
	{
		...
		addAttribute(PROMISE_TYPE).setDataType(STRING)
								  .setNillable(false)
								  .setUnique(true)
								  .setLabel("ProMISe material type")
								  .setDescription("Identifier of the ProMISe material type");
		addAttribute(MIABIS_TYPES).setDataType(STRING)
								  .setNillable(false)
